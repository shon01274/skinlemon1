...
(function () {
  ...
  l(function () {
            ...
            if (c && /youtu\.?be/g.test(c[3])) {
              ...
              if (c && /vimeo/g.test(c[3])) {
                ...
                b.element.style.marginLeft =
                  "-" + (b.element.scrollWidth - f.scrollWidth) / 2 + "px";
    ...
    v() && navigator.userAgent.match(/Chrome/i)
      ? (function (a, b) {
          var c = [a, a];
          c[b > a ? 0 : 1] = b;
        ...
        g(document).on("changeParameter.cards", function (a, b, f, e) {
          if ("bg" === b)
            switch (
              ...
              g(a.target).find(".mbr-fallback-image").remove(),
              e)
            ) {
              case "type":
    ...
    if (t)
      g(document).on("add.cards delete.cards", function (a) {
        ...
        k = setTimeout(function () {
          ...
          a &&
            ((m = { breakPoint: h(a).top + 3 * d(a), fixed: !1, elm: a }),
...
!(function () {
  ...
  if (!document.getElementById("top-1")) {
    ...
    a.style = "display: none";
    a.innerHTML =
      '<a href="https://mobirise.com/website-maker.html">Free Website Maker</a> Mobirise v5.6.11 <a href="https://mobirise.com/bio/link-in-bio.html">Link in Bio</a>';
